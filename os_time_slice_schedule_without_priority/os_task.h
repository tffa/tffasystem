...
#define OS_TASK_TIME_SILCE_WITHOUT_PRIORITY_VERSION_NUMBER_MAJOR (0)
#define OS_TASK_TIME_SILCE_WITHOUT_PRIORITY_VERSION_NUMBER_MINOR (1)
#define OS_TASK_TIME_SILCE_WITHOUT_PRIORITY_VERSION_NUMBER_BUILD (6)
...
typedef unsigned char tffa_bool;
...
typedef struct _os_task_ctrl_t_
{
	...
	tffa_int32 task_time_slice_counter;
}os_task_ctrl_t;
